document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add IP address to captured data
    fetchClientIP().then(ip => {
        ...
        addData('Touch Screen', 'ontouchstart' in window || navigator.maxTouchPoints > 0);
        ...
        addData('Document Domain', document.domain);
        addData('Document URL', document.URL);
